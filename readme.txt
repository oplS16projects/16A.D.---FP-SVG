...
This should be considered drop-in code however I "dropped" it into the main code so you could have any idea of how it will work.
...
Some good news, ellipse seems to be working properly so I dont feel think fixing the others will prove to be too difficult.
